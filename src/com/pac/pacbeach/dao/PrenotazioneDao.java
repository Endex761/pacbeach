...
public class PrenotazioneDao extends Dao
{
    ...
    public static List<Prenotazione> getPrenotazioniUtente(int idUtente) throws NoResultException
    {
        String queryString = "from Prenotazione where refUtente = ?0";

        return (List<Prenotazione>) get(queryString, idUtente);
    }
